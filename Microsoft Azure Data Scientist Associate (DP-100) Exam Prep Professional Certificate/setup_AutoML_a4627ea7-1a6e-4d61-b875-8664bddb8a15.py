...
dataprep_json = "{\"datasets\":0,\"training_data\":{\"datasetId\":\"b0771a49-b140-48d8-b954-7cd51f4a9fce\"}}" # PLACEHOLDER
...
automl_settings = {'enable_early_stopping':True,'enable_ensembling':False,'enable_stack_ensembling':False,'ensemble_iterations':15,'enable_onnx_compatible_models':False,'save_mlflow':True,'max_cores_per_iteration':-1,'send_telemetry':True,'blacklist_algos':['TensorFlowLinearClassifier','TensorFlowDNN'],'whitelist_models':None,'compute_target':'hamzeh-dp100-computer','enable_dnn':True,'enable_code_generation':True,'experiment_exit_score':None,'experiment_timeout_minutes':1440,'featurization':'auto','hyperdrive_config':None,'grain_column_names':None,'is_timeseries':False,'iteration_timeout_minutes':1440,'max_concurrent_iterations':1,'metric_operation':'maximize','model_explainability':True,'n_cross_validations':None,'name':'hamzeh-dp100-labs-exp','path':'./sample_projects/hamzeh-dp100-labs-exp','primary_metric':'AUC_weighted','region':'polandcentral','resource_group':'hamzeh-dp100-labs','subscription_id':'f17cd0f4-b60f-45f6-a293-5a2b48c35850','task_type':'classification','validation_size':0.1,'test_size':None,'vm_type':'Standard_E4ds_v4','workspace_name':'hamzeh-dp100-labs','label_column_name':'Issued_date','positive_label':None,'enable_batch_run':True,'dataset_id':'b0771a49-b140-48d8-b954-7cd51f4a9fce'} # PLACEHOLDER for AutoMLSettings
